[myawesometmlsolution-f224] Operating Details
====================================

Generated On: 2024-11-01 18:44:36 UTC
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-f224] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-f224] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/chiraghanda/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/chiraghanda/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='chiraghanda'  \-\-env DOCKERUSERNAME='chiraghanda'  \-\-env MQTTUSERNAME='chiraghanda22@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   chiraghanda/myawesometmlsolution-f224-amd64 (https://hub.docker.com/r/chiraghanda/myawesometmlsolution-f224-amd64)
...
.. important::
   docker run -d -p 39487:39487 -p 45929:45929 -p 57773:57773 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-f224 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-f224 \-\-env GITUSERNAME=chiraghanda  \-\-env GITREPOURL=https://github.com/chiraghanda/raspberrypi \-\-env SOLUTIONEXTERNALPORT=39487  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=45929  \-\-env SOLUTIONVIPERVIZPORT=57773 \-\-env DOCKERUSERNAME='chiraghanda'  \-\-env EXTERNALPORT= \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='chiraghanda22@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  chiraghanda/myawesometmlsolution-f224-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=57773
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=39487
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - chiraghanda/myawesometmlsolution-f224-amd64
...
It can be accessed by entering: http://localhost:45929
...
.. important::
   http://localhost:57773/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:57773/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:57773/<html file>
...
[myawesometmlsolution-f224] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/chiraghanda/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-f224
...
.. important::
   https://myawesometmlsolution-f224.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-f224
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39487, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37769, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33037, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33121, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34477, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37061, HPDEHOST=127.0.1.1, HPDEPORT=40355, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44167

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2576-myawesometmlsolution-f224,solution_preprocessing_dag-myawesometmlsolution-f224, python-preprocess-5801-myawesometmlsolution-f224,solution_preprocessing_dag-myawesometmlsolution-f224, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
